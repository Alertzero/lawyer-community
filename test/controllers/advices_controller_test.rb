...
class AdvicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create advice" do
    assert_difference('Advice.count') do
      post advices_url, params: { advice: { lawyer_id: @advice.lawyer_id, message: @advice.message, question_id: @advice.question_id } }
    end
  ...
  test "should update advice" do
    patch advice_url(@advice), params: { advice: { lawyer_id: @advice.lawyer_id, message: @advice.message, question_id: @advice.question_id } }
